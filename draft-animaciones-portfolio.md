...
[→ imagen: captura o gif del hero animándose, letras cayendo y la h apareciendo]
...
[→ imagen: captura de la sección Contact con las letras caídas en el suelo]
...
css: |
  ...
  button:hover { background: #1a1a1a; color: #f5f0eb; }
js: |
